...
from .openai_service_base import OpenAIService as BaseOpenAIService
...
class OpenAIServiceFactory:
    ...
    @staticmethod
    def create_service_with_session_manager(session_manager: ChatSessionManager) -> OpenAIService:
        """
