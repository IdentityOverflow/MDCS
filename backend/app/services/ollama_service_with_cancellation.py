...
from .ollama_service import OllamaService as BaseOllamaService
...
class OllamaServiceWithCancellation(BaseOllamaService):
    """
    Enhanced Ollama service with session management and cancellation support.
...
class OllamaServiceFactory:
    ...
    @staticmethod
    def create_service_with_session_manager(session_manager: ChatSessionManager) -> OllamaServiceWithCancellation:
        """
        ...
        """
        return OllamaServiceWithCancellation(session_manager=session_manager)