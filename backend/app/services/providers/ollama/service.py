...
class OllamaService(BaseProviderService):
    ...
    async def send_message_stream_with_session(self, 
        ...
        Yields:
            StreamingChatResponse chunks from Ollama
        """
        if self.session_manager:
...
class OllamaServiceFactory:
    ...
    @classmethod
    def create_service(cls, session_manager=None) -> OllamaService:
        """
    ...
    @classmethod
    def create_service_with_cancellation(cls, session_manager) -> OllamaService:
        """
        Create an Ollama service with cancellation support.
        
        Args:
            session_manager: ChatSessionManager for cancellation
            
        Returns:
            OllamaService configured with session management
        """
        return OllamaService(session_manager=session_manager)