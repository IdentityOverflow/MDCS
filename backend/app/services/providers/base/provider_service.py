...
from app.services.ai_providers import AIProvider, ChatRequest, ChatResponse, StreamingChatResponse, ProviderType
...
class BaseProviderService(AIProvider):
    ...
    async def send_message_stream(
        ...
        """
        Shared streaming implementation using stream processor composition with cancellation.
        ...
        # Process stream using shared processor with cancellation support
        async for response_chunk in self._stream_processor.process_stream(
            chunk_stream,
